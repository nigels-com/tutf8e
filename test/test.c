...
int main(int argc, char *argv[])
{
  ...
  ret = tutf8e_string_encode_iso_8859_1(buffer, sizeof(buffer), finnish);
  ...
  ret = tutf8e_string_encode_iso_8859_2(buffer, sizeof(buffer), czech);
  ...
  ret = tutf8e_string_encode_iso_8859_3(buffer, sizeof(buffer), turkish);
  ...
  ret = tutf8e_string_encode_iso_8859_4(buffer, sizeof(buffer), estonian);
  ...
  ret = tutf8e_string_encode_iso_8859_5(buffer, sizeof(buffer), russian);
  ...
  ret = tutf8e_string_encode_iso_8859_7(buffer, sizeof(buffer), greek);
  ...
  ret = tutf8e_string_encode_iso_8859_8(buffer, sizeof(buffer), hebrew);
  ...
  ret = tutf8e_string_encode_iso_8859_9(buffer, sizeof(buffer), turkish2);
  ...
  ret = tutf8e_string_encode_iso_8859_10(buffer, sizeof(buffer), swedish);
  ...
  ret = tutf8e_string_encode_iso_8859_11(buffer, sizeof(buffer), thai);
  ...
  ret = tutf8e_string_encode_iso_8859_13(buffer, sizeof(buffer), polish);
  ...
  ilen = strlen(english);
  olen = sizeof(buffer);
  ret = tutf8e_buffer_encode_iso_8859_1(buffer, &olen, english, ilen);
  ...
  ilen = strlen(finnish);
  olen = sizeof(buffer);
  ret = tutf8e_buffer_encode_iso_8859_1(buffer, &olen, finnish, ilen);
  ...
  ilen = strlen(czech);
  olen = sizeof(buffer);
  ret = tutf8e_buffer_encode_iso_8859_2(buffer, &olen, czech, ilen);
  ...
  ilen = strlen(turkish);
  olen = sizeof(buffer);
  ret = tutf8e_buffer_encode_iso_8859_3(buffer, &olen, turkish, ilen);
  ...
  olen = sizeof(buffer);
  ret = tutf8e_buffer_encode_iso_8859_4(buffer, &olen, estonian, ilen);
  ...
  ilen = strlen(russian);
  olen = sizeof(buffer);
  ret = tutf8e_buffer_encode_iso_8859_5(buffer, &olen, russian, ilen);
  ...
  ilen = strlen(greek);
  olen = sizeof(buffer);
  ret = tutf8e_buffer_encode_iso_8859_7(buffer, &olen, greek, ilen);
  ...
  ilen = strlen(hebrew);
  olen = sizeof(buffer);
  ret = tutf8e_buffer_encode_iso_8859_8(buffer, &olen, hebrew, ilen);
  ...
  olen = sizeof(buffer);
  ret = tutf8e_buffer_encode_iso_8859_9(buffer, &olen, turkish2, ilen);
  ...
  ilen = strlen(swedish);
  olen = sizeof(buffer);
  ret = tutf8e_buffer_encode_iso_8859_10(buffer, &olen, swedish, ilen);
  ...
  ilen = strlen(thai);
  olen = sizeof(buffer);
  ret = tutf8e_buffer_encode_iso_8859_11(buffer, &olen, thai, ilen);
  ...
  ilen = strlen(polish);
  olen = sizeof(buffer);
  ret = tutf8e_buffer_encode_iso_8859_13(buffer, &olen, polish, ilen);
  ...
  encoded = tutf8e_string_encode_iso_8859_1_realloc(strdup(finnish));
  if (encoded && !strcmp(encoded, finnishUTF8)) {
    printf("%s\n", encoded);
    pass++;
  } else {
    printf("Failed to encode finnish test\n");
