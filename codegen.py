...
with open('src/tutf8e.c', 'w') as src:
  ...
  src.write('\n')
  src.write('int encode_utf8(const uint16_t *table, const unsigned char **i, size_t *ileft, unsigned char **o, size_t *oleft)\n')
  src.write('{\n')
...
with open('include/tutf8e.h', 'w') as include:
  ...
  include.write('\n')
  include.write('extern int encode_utf8(const uint16_t *table, const unsigned char **i, size_t *ileft, unsigned char **o, size_t *oleft);\n')
  include.write('\n')
  ...
  for e in sorted(encodings):
    ...
    with open('src/%s.c'%(name), 'w') as src:
      ...
      src.write('  return encode_utf8(%s_utf8, (const unsigned char **) &src, &len, (unsigned char **) &dest, &size);\n'%(name))
      src.write('}\n')
