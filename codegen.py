...
with open('src/tutf8e.c', 'w') as src:
  ...
  src.write('\n')
  src.write('int encode_utf8(const uint16_t *table, const char **ibuf, size_t *ileft, char **obuf, size_t *oleft)\n')
  src.write('{\n')
  src.write('  const unsigned char **i = (const unsigned char **) ibuf;\n')
  src.write('  unsigned char **o = (unsigned char **) obuf;\n')
  src.write('  for (; *ileft; *i += 1, *ileft -= 1) {\n')
  src.write('    uint16_t c = table[**i];\n')
  src.write('    if (c<0x80) {\n')
  src.write('      if (*oleft<1) return -2;\n')
  src.write('      (*o)[0] = c;\n')
  src.write('      *o += 1;\n')
  src.write('      *oleft -= 1;\n')
  src.write('      continue;\n')
  ...
  src.write('      if (*oleft<2) return -2;\n')
  src.write('      (*o)[0] = 0xc0 | (c>>6);\n')
  src.write('      (*o)[1] = 0x80 | (c&0x3f);\n')
  src.write('      *o += 2;\n')
  src.write('      *oleft -= 2;\n')
  src.write('      continue;\n')
  src.write('    }\n')
  src.write('    if (c<0xffff) {\n')
  src.write('      if (*oleft<3) return -2;\n')
  src.write('      (*o)[0] = 0xe0 | (c>>12);\n')
  src.write('      (*o)[1] = 0x80 | ((c>>6)&0x3f);\n')
  src.write('      (*o)[2] = 0x80 | (c&0x3f);\n')
  src.write('      *o += 3;\n')
  src.write('      *oleft -= 3;\n')
  src.write('      continue;\n')
  src.write('    }\n')
...
with open('include/tutf8e.h', 'w') as include:
  ...
  include.write('\n')
  include.write('extern int encode_utf8(const uint16_t *table, const char **i, size_t *ileft, char **o, size_t *oleft);\n')
  include.write('\n')
