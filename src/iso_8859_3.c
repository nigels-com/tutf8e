...
static const uint16_t iso_8859_3_utf8[256] =
{
...
int tutf8e_string_encode_iso_8859_3(char *output, size_t olen, const char *input)
{
  size_t len = strlen(input) + 1;
  return tutf8e_buffer_encode(iso_8859_3_utf8, input, len, output, &olen);
}

int tutf8e_buffer_length_iso_8859_3(const char *i, size_t ilen, size_t *length)
{
  return tutf8e_buffer_length(iso_8859_3_utf8, i, ilen, length);
}

int tutf8e_buffer_encode_iso_8859_3(char *output, size_t *olen, const char *input, size_t ilen)
{
  return tutf8e_buffer_encode(iso_8859_3_utf8, input, ilen, output, olen);
}

char * tutf8e_string_encode_iso_8859_3_realloc(char *input)
{
  size_t ilen = 0;
  size_t olen = 0;
  if (input && !tutf8e_string_length(iso_8859_3_utf8, input, &ilen, &olen) && ilen && olen && ilen!=olen) {
    char * output = malloc(olen + 1);
    if (output && !tutf8e_buffer_encode(iso_8859_3_utf8, input, ilen, output, &olen)) {
      free(input);
      output[olen] = 0;
      return output;
    }
